...
echo "  kubectl --kubeconfig $target_kubeconfig apply -f example/80-diki-options-configmap.yaml"
echo "  kubectl --kubeconfig $target_kubeconfig apply -f example/80-reportoutput-configmap.yaml"
